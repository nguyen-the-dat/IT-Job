            ...
            <div class="row align-items-center pxp-sign-hero-container">
                <div class="col-xl-6 pxp-column">
                    <div class="pxp-sign-hero-fig text-center pb-100 pt-100">
                        ...
                        <h1 class="mt-4 mt-lg-5">Register for company</h1>
                    </div>
                </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-6 col-xl-7 col-xxl-5">
                                ...
                                <div class="pxp-sign-hero-form-content">
                                    ...
                                    <form class="mt-4" action="../Register/Enterprise" method="post">
                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="pxp-signup-page-email" name="username">
                                            <label for="pxp-signup-page-email">Username</label>
                                            <span class="fa fa-envelope-o"></span>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control" id="pxp-signup-page-password" name="password">
                                            <label for="pxp-signup-page-password">Create password</label>
                                            <span class="fa fa-lock"></span>
                                        </div>
                                        <h5>About Enterprise</h5>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="pxp-signup-page-email" name="fullCompanyName">
                                            <label for="pxp-signup-page-email">Full company name</label>
                                            <span class="fa fa-envelope-o"></span>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control" id="pxp-signup-page-email" name="email">
                                            <label for="pxp-signup-page-email">Email</label>
                                            <span class="fa fa-envelope-o"></span>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="pxp-signup-page-email" name="phoneNumber">
                                            <label for="pxp-signup-page-email">Phone number</label>
                                            <span class="fa fa-envelope-o"></span>
                                        </div>

                                        <div class="form-floating mb-3">
                                            <input type="text" class="form-control" id="pxp-signup-page-email" name="address">
                                            <label for="pxp-signup-page-email">Address</label>
                                            <span class="fa fa-envelope-o"></span>
                                        </div>

                                        <!--                                        <a href="../Register/Enterprise" class="btn rounded-pill pxp-sign-hero-form-cta">Continue</a>-->
<!--                                        <input type="submit" value="Continue" class="btn rounded-pill pxp-sign-hero-form-cta">-->
