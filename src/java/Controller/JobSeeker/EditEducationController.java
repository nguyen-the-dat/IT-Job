 ...
 * @author ADMIN
 */
public class EditEducationController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            educationDAO.edit(title,school,degree,convertStringToTimeStamp(startTime),convertStringToTimeStamp(endTime),description,id);
