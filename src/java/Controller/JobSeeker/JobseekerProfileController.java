...
public class JobseekerProfileController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (jobSeeker != null) {
            ...
            request.setAttribute("eduList", educationsForJobSeeker);
            request.setAttribute("expList", workExperiencesForJobSeeker);
            request.setAttribute("skillList", skills);
            request.setAttribute("jobseeker", jobSeeker);
            request.getRequestDispatcher("jobseeker_profile.jsp").forward(request, response);
        } else {
