...
public class ManageJob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ManageJob</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ManageJob at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        if (session != null) {
            ...
            if (account != null && account.getRoleId() == 1) {
                ...
                if (enterprise != null) {
                    ...
                    List<Job> jobs = jd.getJobByEnterprise(enterprise.getId());
