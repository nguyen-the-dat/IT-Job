...
public class Enterprise {
    ...
    public Enterprise(int id, String shortName, String fullCompanyName, String logoUrl, int foundedYear, EnterpriseSizeDetail enterpriseSizeDetail, String taxCode, String businessLicenseFront, String businessLicenseBack, String websiteUrl, String facebookUrl, String phoneContact, String emailContact, String imageUrl, String description, String address, CompanyTypeDetail companyTypeDetail, int workingday, String country, String accountId) {
        this.id = id;
    ...
    public String toString() {
        return "Enterprise{" + "id=" + id + ", shortName=" + shortName + ", fullCompanyName=" + fullCompanyName + ", logoUrl=" + logoUrl + ", foundedYear=" + foundedYear + ", enterpriseSizeDetail=" + enterpriseSizeDetail + ", taxCode=" + taxCode + ", businessLicenseFront=" + businessLicenseFront + ", businessLicenseBack=" + businessLicenseBack + ", websiteUrl=" + websiteUrl + ", facebookUrl=" + facebookUrl + ", phoneContact=" + phoneContact + ", emailContact=" + emailContact + ", imageUrl=" + imageUrl + ", description=" + description + ", address=" + address + ", companyTypeDetail=" + companyTypeDetail + ", workingday=" + workingday + ", country=" + country + ", accountId=" + accountId + '}';
    }
